 ...
 */
@Data
@TableName("kid_task_records")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@Schema(description="儿童习惯任务记录表")
public class KidTaskRecords implements Serializable {
	...
	/**任务_id*/
	@Excel(name = "任务_id", width = 15)
    @Schema(description = "任务_id")
    private java.lang.String taskId;
	/**是否完成*/
    @Excel(name = "是否完成", width = 15,replace = {"是_Y","否_N"} )
	...
	/**任务完成日期*/
	@Excel(name = "任务完成日期", width = 15, format = "yyyy-MM-dd")
	@JsonFormat(timezone = "GMT+8",pattern = "yyyy-MM-dd")
    @DateTimeFormat(pattern="yyyy-MM-dd")
